            ...
            <div class="row">
                <div class="col-12 col-lg-8 mb-5 mb-lg-0">
                    <div class="card card-discussions mb-5">
                        <div class="row">
                            <div class="col-1 d-flex flex-column justify-content-start align-items-center">
                                <a href="#">
                                    <img src="{{ url('assets/images/like.png') }}" alt="icon like" class="like-icon mb-1">
                                </a>
                            ...
                            <div class="col-11">
                                ...
                                <div class="mb-3">
                                    <a href="#"> <span  class="badge rounded-pill text-bg-light">Faced</span></a>
                                </div>
                    ...
                    <div class="mb-5">
                        ...
                        <div class="card card-disccusions ">
                            <div class="row">
                                <div class="col-1 d-flex flex-column justify-content-start align-items-center">
                                    <a href="#">
                                ...
                                <div class="col-11">
                                    <p>
                                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Qui adipisci amet odio.
                                    </p>
                    ...
                    <div class="fw-bold text-center">Plase <a href="#" class="text-primary">sign in</a> or <a href="#" class="text-primary">create account</a> to participant in discussions</div>
